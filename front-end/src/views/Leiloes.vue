<template>
    <div class="container">
        <form @submit.prevent="salvar(), listar()">
            ...
            <div class="columns">
                <div class="column">
                    ...
                    <div class="column">
                        <label class="label">DATA ENCERRAMENTO</label>
        ...
        <br>
        <label class="label">FILTRAR POR SITUAÇÃO</label>
            ...
            <tbody>
                <tr v-for="leilao of leiloes" :key="leilao.id">
                    ...
                    <td>
                        <router-link
                            class="mr-3"
                            :to="{ name: 'lances', params: { id: leilao.id, lanceMinimo: leilao.lanceMinimo, item: leilao.item} }"
                            >
                            <button v-show="leilao.status == 'ABERTO'" class="button is-link">Dar Lances</button>
                            </router-link>
                        <button @click="editar(leilao), listar()" class="button is-warning"><i class="material-icons">Editar</i></button>
